...
func (repo *Penalty)NewPenaltyClassification (class model.PenaltyClassification)(error){
...
func (repo *Penalty)UpdatePenaltyClassification (class model.PenaltyClassification)(error){
...
func (repo *Penalty)GetPenaltyClassifications()([]model.PenaltyClassification, error){
...
func (repo *Penalty)DeletePenaltyClassification(id string) error {
