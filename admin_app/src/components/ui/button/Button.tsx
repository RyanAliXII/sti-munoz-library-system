...
export enum ButtonClasses {
  PrimaryButtonDefaultClasslist = "bg-blue-500 p-2 rounded text-sm text-white font-semibold disabled:opacity-50",
  DangerButtonDefaultClasslist = "bg-red-500 p-2 rounded text-sm text-white font-semibold disabled:opacity-50",
...
const Spinner = () => {
  return (
    <div role="status">
      <svg
        aria-hidden="true"
        className="w-5  text-gray-200 animate-spin dark:text-gray-600 fill-gray-400"
        viewBox="0 0 100 101"
        fill="none"
...
export const PrimaryButton: React.FC<ButtonProps> = (props: ButtonProps) => {
  return (
    <button
      disabled={!props?.isLoading ? false : true}
      {...{
        ...props,
