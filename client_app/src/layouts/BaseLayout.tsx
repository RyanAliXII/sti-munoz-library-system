...
const MainContent: FC<PropsWithChildren<BaseLayoutProps>> = function ({
  children,
  isFooter,
}) {
  return (
    <main className="relative min-h-screen w-full overflow-y-auto bg-gray-50 dark:bg-gray-900">
      {children}
      {/* {isFooter && (
